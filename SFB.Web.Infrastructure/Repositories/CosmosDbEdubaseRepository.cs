...
namespace SFB.Web.Infrastructure.Repositories
{
    public class CosmosDbEdubaseRepository : AppInsightsLoggable, IEdubaseRepository
    {
        ...
        private async Task<List<EdubaseDataObject>> GetSchoolDataObjectByIdAsync(Dictionary<string, object> fields)
        {
            ...
            var queryString =
                $"SELECT c['{EdubaseDataFieldNames.URN}'], c['{EdubaseDataFieldNames.UID}'], c['{EdubaseDataFieldNames.ESTAB_NAME}'], c['{EdubaseDataFieldNames.OVERALL_PHASE}'], c['{EdubaseDataFieldNames.PHASE_OF_EDUCATION}'], c['{EdubaseDataFieldNames.TYPE_OF_ESTAB}'], c['{EdubaseDataFieldNames.STREET}'], c['{EdubaseDataFieldNames.TOWN}'], c['{EdubaseDataFieldNames.LOCATION}'], c['{EdubaseDataFieldNames.POSTCODE}'], c['{EdubaseDataFieldNames.TRUSTS}'], c['{EdubaseDataFieldNames.COMPANY_NUMBER}'], " +
